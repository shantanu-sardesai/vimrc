...
local github = { "projekt0n/github-nvim-theme", name = "github-theme" } -- https://github.com/projekt0n/github-nvim-theme
...
local ayu = { "ayu-theme/ayu-vim" } -- https://github.com/ayu-theme/ayu-vim
local darcula_dark = { "xiantang/darcula-dark.nvim" } -- https://github.com/xiantang/darcula-dark.nvim?tab=readme-ov-file
